...
int main()
{
  ...
  cout << "sizepile of data: " << pileOfData.size() << endl;
  cout << "size allComboDemogData: " << theCounties.allComboDemogData.size() << endl;

  cout << "sizeX: " << dataX.size() << endl;
  cout << "sizeY: " << dataY.size() << endl;
